...
import com.collagemaker_makeanything.Api.Groups
...
class BackgroundAdapter(var activity: Activity, private var data: MutableList<Groups>) : RecyclerView.Adapter<BackgroundAdapter.BackgroundViewHolder>()
{
